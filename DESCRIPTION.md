A **client-side** Fabric mod that makes attribute swapping **Visual** :).
...
Note that this mode **`DOES NOT`**:

- Enhance the mechanic of how attribute swapping to give a competitive edge over players without this mod.
...
## Configuration (via Mod Menu or Cloth Config)
